...
SYSTEM = (
    ...
    "- Haz al menos 5 preguntas antes de terminar, salvo que el perfil sea "
    "evidentísimo. Marca terminado=true cuando las respuestas apunten de forma "
    "consistente a una o pocas áreas, o al llegar a unas 7 preguntas.\n"
